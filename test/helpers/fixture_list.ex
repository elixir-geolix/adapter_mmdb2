defmodule Geolix.Adapter.MMDB2TestHelpers.FixtureList do
  ...
  def get() do
    [
      {
        :fixture_anonymous,
        "GeoIP-Anonymous-IP-Test.mmdb",
        "#{@base_maxmind}/GeoIP2-Anonymous-IP-Test.mmdb"
      },
      ...
      {:fixture_city, "GeoIP2-City-Test.mmdb", "#{@base_maxmind}/GeoIP2-City-Test.mmdb"},
      {
        ...
        "#{@base_maxmind}/GeoIP2-Connection-Type-Test.mmdb"
      },
      ...
      {:fixture_domain, "GeoIP2-Domain-Test.mmdb", "#{@base_maxmind}/GeoIP2-Domain-Test.mmdb"},
      {
        ...
        "#{@base_maxmind}/GeoIP2-Enterprise-Test.mmdb"
      },
      {:fixture_isp, "GeoIP2-ISP-Test.mmdb", "#{@base_maxmind}/GeoIP2-ISP-Test.mmdb"},
      {
        :fixture_decoder,
        "MaxMind-DB-test-decoder.mmdb",
        "#{@base_maxmind}/MaxMind-DB-test-decoder.mmdb"
      },
      {
        :fixture_ipv4_24,
        "MaxMind-DB-test-ipv4-24.mmdb",
        "#{@base_maxmind}/MaxMind-DB-test-ipv4-24.mmdb"
      },
      {
        :fixture_ipv4_28,
        "MaxMind-DB-test-ipv4-28.mmdb",
        "#{@base_maxmind}/MaxMind-DB-test-ipv4-28.mmdb"
      },
      {
        :fixture_ipv4_32,
        "MaxMind-DB-test-ipv4-32.mmdb",
        "#{@base_maxmind}/MaxMind-DB-test-ipv4-32.mmdb"
      },
      {
        :fixture_ipv6_24,
        "MaxMind-DB-test-ipv6-24.mmdb",
        "#{@base_maxmind}/MaxMind-DB-test-ipv6-24.mmdb"
      },
      {
        :fixture_ipv6_28,
        "MaxMind-DB-test-ipv6-28.mmdb",
        "#{@base_maxmind}/MaxMind-DB-test-ipv6-28.mmdb"
      },
      {
        :fixture_ipv6_32,
        "MaxMind-DB-test-ipv6-32.mmdb",
        "#{@base_maxmind}/MaxMind-DB-test-ipv6-32.mmdb"
      },
      {
        :fixture_broken_pointers,
        "MaxMind-DB-test-broken-pointers-24.mmdb",
        "#{@base_maxmind}/MaxMind-DB-test-broken-pointers-24.mmdb"
      },
      {
